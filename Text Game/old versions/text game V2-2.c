...
//--- ROOMS ---
int GuestBedroom(int room, INVENTORY *inv, char* file);
int UpperHallway(int room, INVENTORY *inv, char* file);
int MasterBedroom(int room, INVENTORY *inv, char* file);
int LowerHallway(int room, INVENTORY *inv, char* file);
int Kitchen(int room, INVENTORY *inv, char* file);
int Bathroom(int room, INVENTORY *inv, char* file);
int LivingRoom(int room, INVENTORY *inv, char* file);
...
void GuestBook();
void GuestJar(INVENTORY *inv, char* file);

void Staircase();

void MasterBed(char* file);
void MasterTable(INVENTORY *inv, char* file);
void Glasses(INVENTORY *inv, char* file);
void Clock();
void MasterJar();
...
void KitchenSink(INVENTORY *inv, char* file);
void Stove();
...
void Fireplace(INVENTORY *inv, char* file);
...
int main(void) {
	...
	do {
		...
		case GUEST_BEDROOM:
			...
			printf("\n---------------\n");
			room = GuestBedroom(room, &inventory, filename);
			break;
		...
		case UPPER_HALLWAY:
			...
			printf("\n---------------\n");
			room = UpperHallway(room, &inventory, filename);
			break;
		...
		case MASTER_BEDROOM:
			...
			printf("\n---------------\n");
			room = MasterBedroom(room, &inventory, filename);
			break;
		...
		case LOWER_HALLWAY:
			...
			printf("\n---------------\n");
			room = LowerHallway(room, &inventory, filename);
			break;
		...
		case KITCHEN:
			...
			printf("KITCHEN");
			printf("\n---------------\n");
			room = Kitchen(room, &inventory, filename);
			break;
		...
		case BATHROOM:
			...
			printf("BATHROOM");
			printf("\n---------------\n");
			room = Bathroom(room, &inventory, filename);
			break;
		...
		case LIVING_ROOM:
			...
			printf("LIVING ROOM");
			printf("\n---------------\n");
			room = LivingRoom(room, &inventory, filename);
			break;
